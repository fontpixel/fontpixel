// Generated by `python -m opf.coverage.gen.gen_blocks_ts`. Do not edit by hand.
// Source: UCD Blocks.txt (the same data used by the pipeline's coverage stats).

/** Unicode block name → [start codepoint, end codepoint] (inclusive). */
