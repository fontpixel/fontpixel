/* eslint-disable */
// Generated by port_docs2.py from <BDF func={…}> usages in the original site's MDX; edit demos here.
/** A single live demo: fn receives the loaded Font and the collection of bdfparser classes. */
