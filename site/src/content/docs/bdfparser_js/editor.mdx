...
description: "Try bdfparser in a live JavaScript editor: load a BDF font, render pixel text, and experiment with bitmap operations."
label: "Live Demo & Code Editor"
order: 0.5
---

import BDFEditor from '@dc/BDFEditor.svelte';
