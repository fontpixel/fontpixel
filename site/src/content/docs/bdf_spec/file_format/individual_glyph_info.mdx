...
description: "Reference for BDF glyph records: character encoding, advance widths, bounding boxes, bitmap rows, and glyph delimiters."
label: "Individual Glyph Info"
order: 5
---
...
import Keyword from '@dc/Keyword.astro';
