...
description: "Create a font with Adobe Illustrator and FontForge using the Font Template workflow, from drawing glyphs to exporting an installable font."
label: "Font Template"
order: 0
---
...
<p align="center">
<a href="https://github.com/fontpixel/font-template" target="_blank" rel="noopener noreferrer">GitHub repository</a>
</p>

## Files

* **`font_template.ai`** ([download](https://github.com/fontpixel/font-template/raw/master/font_template.ai)): Adobe Illustrator font template for basic and extended symbols and latin letters (significant CP1252 coverage), each glyph has a separate artboard, so that you can easily export each of them as individual glyph SVG file.
* **`font_template_single.ai`** ([download](https://github.com/fontpixel/font-template/raw/master/font_template_single.ai)): Adobe Illustrator font template for a single glyph. If you want, you can use this file instead of (or along with) `font_template.ai`.
* **`batch_import_svg.py`** ([open](https://github.com/fontpixel/font-template/raw/master/batch_import_svg.py), then <kbd>Ctrl</kbd>+<kbd>S</kbd> / <kbd>Cmd</kbd>+<kbd>S</kbd> to save): a python script that can import multiple SVG individual glyph files into FontForge's `.sfd` font file (and can optionally convert it to production font files, i.e. `.otf`, `.ttf`, `.woff`, `.woff2`, etc.)

(Instead of downloading the files, you may also `git clone `[`https://github.com/fontpixel/font-template.git`](https://github.com/fontpixel/font-template.git) or [download the whole repository](https://github.com/fontpixel/font-template/archive/master.zip))
...
![AI font template](https://raw.githubusercontent.com/fontpixel/font-template/master/img/1-ai_font_template.png)

After finishing drawing the glyphs, hide "Example glyph" layer. Click "File" -> "Export" -> "Export for Screens".

![AI menu export](https://raw.githubusercontent.com/fontpixel/font-template/master/img/2-ai_menu_export.png)

Select the glyphs you want to export (do not select empty ones), select "SVG" format, click "Export Artboard".

![AI export](https://raw.githubusercontent.com/fontpixel/font-template/master/img/3-ai_export.png)
...
![FontForge import](https://raw.githubusercontent.com/fontpixel/font-template/master/img/4-fontforge_import.png)
...
![FontForge adjust width](https://raw.githubusercontent.com/fontpixel/font-template/master/img/5-fontforge_adjust_width.png)

In the menu, select "File" -> "Generate Fonts..."

![FontForge menu generate font](https://raw.githubusercontent.com/fontpixel/font-template/master/img/6-fontforge_menu_generate_font.png)
...
![FontForge generate font](https://raw.githubusercontent.com/fontpixel/font-template/master/img/7-fontforge_generate_font.png)
...
![Font template single description](https://raw.githubusercontent.com/fontpixel/font-template/master/template_desc/font_template_single_description.png)
...
[MIT License](https://github.com/fontpixel/font-template/blob/master/LICENSE) for everything in this repository
