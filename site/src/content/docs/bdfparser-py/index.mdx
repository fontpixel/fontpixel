...
description: "Parse BDF bitmap fonts in Python, inspect glyphs, draw text, and transform bitmap images with the bdfparser library."
label: "BDF Parser (Python) - Overview"
order: 0
---
...
The BDF Parser TypeScript (JavaScript) library has a [**Live Demo & Editor**](../bdfparser-js/editor/) you can try.
