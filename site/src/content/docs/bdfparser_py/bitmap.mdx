---
title: "Bitmap object"
description: "Use the bdfparser Bitmap object in Python to crop, resize, concatenate, transform, and export bitmap images."
label: "Bitmap object"
order: 3
---
...
<details>
<summary>Click to see the output of the above code</summary>
