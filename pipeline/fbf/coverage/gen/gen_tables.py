...
运行（在仓库根）：
    .venv/bin/python -m fbf.coverage.gen.gen_tables --all --old-dir <旧项目cjk-tables目录>

生成物直接写入 fbf/coverage/data/ 并入库；可重跑，输出确定。
"""
...
def gen_external() -> None:
    from fbf.coverage.charsets import parse_charset_file
